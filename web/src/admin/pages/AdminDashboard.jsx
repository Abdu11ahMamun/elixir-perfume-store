...
export default function AdminDashboard() {
  ...
  // Stat cards are built only from real API data — no fake fallback numbers.
  const stats = [
    ...
    { id: "revenue",  label: "Total Revenue",  value: summary ? formatCurrency(summary.totalRevenue) : undefined, helper: "Lifetime revenue", icon: "✦" },
  ];
